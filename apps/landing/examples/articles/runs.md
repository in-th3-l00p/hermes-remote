...
- errors are only surfaced when the signal *wasn't* aborted, because a canceled
...
plain 404; the API doesn't even confirm the run exists. In the hosted demo
the "agent task" is answered from built-in demo data in your browser; on a
